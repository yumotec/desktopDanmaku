...
<picture>
  <source srcset="./resource/icon/ori-icon-for_dark.png" media="(prefers-color-scheme: dark)">
  <img src="./resource/icon/ori-icon-for_light.png" alt="LOGO" width="256" height="256">
</picture>
...
软件允许你在电脑桌面上发送弹幕，灵感来源于：[用 Visual Basic 写的桌面弹幕程序](https://github.com/wsrj/desk-danmaku-vb)

![截图](./resource/for_readme/application-screenshoot.png)
...
makefile从[keybonk项目](https://github.com/xiaoditx/keybonk)中移植而来，可能会有不合适的写法。
